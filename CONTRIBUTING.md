# Contributing to Byndyusoft.AspNetCore.Mvc.Formatters.ProtoBuf
...
If you want to fix, to add enhancement, or to improve documentation, you need to learn how to work with GitHub, Byndyusoft.AspNetCore.Mvc.Formatters.ProtoBuf code base and contributing rules.
...
```shell
 git clone https://github.com/Byndyusoft/Byndyusoft.AspNetCore.Mvc.Formatters.ProtoBuf.git
```
